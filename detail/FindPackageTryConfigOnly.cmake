#.rst:
# FindPackageTryConfigOnly
# -------------------------
#
# Helper macro to write find modules which hijack the offical find modules
# from the CMake distribution and try to find the config module only:
#
# Usage:
# ^^^^^^
#
...
# line:
#
#   include(FindPackageTryConfigOnly)
#   find_package_try_config_only()
#
...
# attempt to find the ZLIB config module instead.
#
# Note: the ``OPTIONAL_COMPONENTS`` and ``NO_POLICY_SCOPE`` parameters
# are not handled.

macro(find_package_try_config_only)
    ...
    if(NOT _FPTCF_package_name)
        message(FATAL_ERROR "FindPackageTryConfigOnly must be included from a find module, it was called from ${_FPTCF_find_module_filename}")
    endif()
